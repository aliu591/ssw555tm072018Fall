...
public class CheckPersonInfoTest {
	...
	public void testUS18() throws Exception {
        ...
        assertEquals("ERROR: Individual: US18: Individual ID I3 married with other sibling in family" + separator
                + "ERROR: Individual: US18: Individual ID I4 married with other sibling in family" + separator, os.toString());
